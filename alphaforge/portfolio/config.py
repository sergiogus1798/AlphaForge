...
class PortfolioConfig:
    ...
    same_asset_window_hours: float = 4.0     # min hours between trades on the same asset (0 = disabled)
    ...
    enable_tail_corr_filter: bool = False
    ...
    ga_seed_attempts_multiplier: int = 10000 # random attempts per individual during seeding (target × this)
    ...
    ga_use_greedy: bool = False              # use greedy independent-set seeding (recommended for large portfolios)
