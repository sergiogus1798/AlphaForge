"""
run_distribution.py — Launch the Distribution panel for AlphaForge.

Usage:
    python run_distribution.py                          # all strategies, first as default
    python run_distribution.py "AUDJPY/Strategy 11"    # open on specific strategy
"""
...
from alphaforge.IndividualAnalysis.Distribution.plot_distribution_panel import (
...
if __name__ == "__main__":
    ...
    if args:
        ...
        initial_key = PORTFOLIO_KEY

    print(f"Opening: {initial_key}")
    plot_distribution_panel(strategies, initial_key,
